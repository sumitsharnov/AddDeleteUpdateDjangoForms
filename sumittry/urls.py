...
urlpatterns = [
    ...
    path('failedmessage', views.successmessage, name='failedmessage'),
    path('updatedetailsuccess', views.updatedetailsuccess, name='updatedetailsuccess')
]
